...
const LearningGridArray = [
  {
    ...
    description:
      'StudyBoost partners with more than 275+ leading universities and companies to bring flexible, affordable, job-relevant online learning to individuals and organizations worldwide.',
    BtnText: 'Learn More',
    BtnLink: '/',
  },
  {
  ...
  },
  {
    ...
    description:
      'StudyBoost partners with more than 275+ leading universities and companies to bring',
  },
  {
    order: 3,
