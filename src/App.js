...
import VerifyPaymentEmail from './pages/VerifyPaymentEmail';
import ViewCourse from './pages/ViewCourse';
import { getUserDetails } from './services/operations/profileAPI';
import { ACCOUNT_TYPE } from './utils/constants';
import PurchaseHstory from './components/core/Dashboard/Settings/PurchaseHstory';
  ...
  return (
    <div className="w-screen min-h-screen bg-richblack-900 flex flex-col font-inter">
      ...
      <Routes>
        ...
        />
        <Route
          path="verify-payment-email/:courseId"
          element={
            <PrivateRoute>
              <VerifyPaymentEmail />
            </PrivateRoute>
